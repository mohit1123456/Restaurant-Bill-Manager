# Tasks Checklist - Restaurant Bill Manager

The detailed backend checklist is also available at [backend/Tasks Checklist.md](backend/Tasks%20Checklist.md), and the frontend checklist is at [frontend/Tasks Checklist.md](frontend/Tasks%20Checklist.md).

The backend and frontend checklists track implementation details. Check an item only when it is implemented and verified.

## Project progress

- [x] Backend pricing engine and REST API implemented
- [x] Frontend React/Vite application bootstrapped
- [x] Frontend menu and order workflow implemented
- [x] Frontend bill preview and finalization connected
- [x] Frontend category filtering and component tests added
- [x] Frontend menu and offer management CRUD connected
- [ ] Frontend management CRUD completed
- [ ] Full cross-application integration test completed
